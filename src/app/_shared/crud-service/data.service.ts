...
export class DataService {
  ...
  readObs<T>(model: T | any, query?: HttpParams | string | any): Observable<T[]> {
    ...
    readObsId<T, S>(model: T | any, id: S | any): Observable<T> {
        return this.DR.readObsId(model, id);
    }
  ...
  // UPDATE
  updatex<T>(model: T | any, objToUpdate: T | any,param: T|any) {
    this.DX.updatex(model, objToUpdate,param);
  }

  updatexObs<T>(model: T | any, objToUpdate: T | any,param: T|any): Observable<T[]> {
    return this.DX.updatexObs(model, objToUpdate,param);
  }

  updatexPromise<T>(model: T | any, objToUpdate: T | any,param: T|any): Promise<T | any> {
    return this.DX.updatexPromise(model, objToUpdate,param);
  }
