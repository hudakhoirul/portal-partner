module.exports = (names, params) => {
    return `
        ...
        <hr class="mb-20">
        <form name="form" [formGroup]="${names.camelCase}Form" (ngSubmit)="${names.pascalCase}Type()">
                ...
                <div fxLayout="column" fxLayoutAlign="start" fxFlex="1 0 auto">
                    ...
                    <div fxLayout="row" fxLayoutAlign="start center" fxFlex="1 0 auto">
                        <mat-form-field fxFlex="100">
                            ...
                            <input matInput formControlName="${names.camelCase}" required
                                cdkFocusInitial>
            ...
            <mat-dialog-actions class="mb-4" align="end">
                ...
                <button mat-raised-button color="accent" class="ml-8" type="submit" [disabled]="!${names.camelCase}Form.valid">
